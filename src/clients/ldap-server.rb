...
module Yast
  class LdapServerClient < Client
    def main
      ...
      Builtins.y2milestone("LdapServer module started")
      ...
      # Finish
      Builtins.y2milestone("LdapServer module finished")
      Builtins.y2milestone("----------------------------------------")
    ...
    def getSchemaListHandler(options)
      ...
      s = ""
      i = 0
      Builtins.foreach(LdapServer.ReadSchemaList) do |v|
    ...
    def addSchemaHandler(options)
      ...
      if Ops.get_string(options, "file", "") != ""
        ...
        elsif !LdapServer.AddLdifToSchemaList(file)
          err = LdapServer.ReadError
          Report.Error(
            Ops.add(
              Ops.add(Ops.get(err, "msg", ""), "<br>"),
...
Yast::LdapServerClient.new.main
